...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        match scores.get(&team_1_name){
            Some(t) => {
                scores.insert(team_1_name, Team{goals_scored: team_1_score + t.goals_scored, goals_conceded: team_2_score + t.goals_conceded})
            }
        ...
        match scores.get(&team_2_name){
            Some(t) => {
                scores.insert(team_2_name, Team{goals_scored: team_2_score + t.goals_scored, goals_conceded: team_1_score + t.goals_conceded})
            }
